...
let javaScriptFromBeginnerToProfessional = {
...
let reactKeyConcepts = {
    title: "React Key Concepts: Consolidate your knowledge of React’s core features",
    pageCount: 590,
    genre: "JavaScript Programming",
    authors: [{
        name: "Maximilian Schwarzmuller", age: 41
    }]
};

let learningWebDesign = {
    title: "Learning Web Design: A Beginner's Guide to HTML, CSS, JavaScript, and Web Graphics",
    pageCount: 811,
    genre: "JavaScript Programming",
    authors: [{
        name: "Jennifer Robbins", age: 38
    }]
};
...
let beginningSvelte = {
    ...
    genre: "JavaScript Programming",
    authors: [{
        name: "Greg Lim", age: 47
    }, {
        name: "Daniel Correa", age: 45
    }]
};
