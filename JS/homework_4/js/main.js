...
let navPane = nav.getElementsByTagName("p");
let section = document.getElementsByClassName("article")[0];
let sectionPane = section.getElementsByTagName("section");

for (let i = 0; i < navPane.length; i++) {
    navPane[i].addEventListener("click", function () {
        nav.getElementsByClassName("active")[0].classList.remove("active");
        navPane[i].classList.add("active");
        section.getElementsByClassName("active")[0].classList.remove("active");
        sectionPane[i].classList.add("active");
    })
}